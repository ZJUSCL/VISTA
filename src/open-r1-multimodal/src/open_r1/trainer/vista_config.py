...
@dataclass
class VISTAConfig(TrainingArguments):
    r"""
    Configuration class for the [`VISTATrainer`].

    Only the parameters specific to VISTA training are listed here. For details on other parameters, refer to the
    ...
    Parameters:
        ...
        model_init_kwargs (`dict[str, Any]` or `None`, *optional*, defaults to `None`):
            ...
            argument of the [`VISTATrainer`] is provided as a string.
    ...
    # Parameters that control the data preprocessing
    # The default value remove_unused_columns is overwritten from the parent class, because in VISTA we usually rely on
